...
interface IPlugin {
    ...
    // function preUserOpValidationHook(uint8 functionId, UserOperation memory userOp, bytes32 userOpHash) external returns (uint256);   TODO UserOperation
    ...
    //     external
    //     returns (uint256);  //TODO UserOperation
